...
$Queried_Object_Data = get_queried_object();
print_r($Queried_Object_Data);

echo "Page_id: ".$Queried_Object_Data->ID;
...
?>
      ...
      <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        <div class="row gy-5 justify-content-between">
          ...
          <div class="col-lg-5 order-1 order-lg-2">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/hero-img.svg" class="img-fluid" alt="">
          </div>
        </div>
      </div>
    ...
    <section id="stats" class="stats section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-lg-5">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/stats-img.svg" alt="" class="img-fluid">
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/blog/blog-author-3.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
  ...
  <?php //$cat = get_categories(array('taxonomy'=>'category','hide_empty'=>false,'exclude'=>1));
          // print_r($cat); 
        //  $catt = get_category_link(6);
        //      print_r($catt);
...
<!-- Below is the examle of wp_query(it is a way to access data of custom postb type) -->
<?php 
            // $wpnew = array(
            //   'post_type'=> 'portfolio',
            //   'post_status'=>'publish'
            ...
            //   echo $content." "." and title is: ".$title;
            // }

            $portcat = get_terms(['taxonomy'=>'portfolio_category']);
            // print_r($portcat);

              echo the_permalink(20);
